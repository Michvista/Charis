          ...
          <section className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center min-h-[420px]">
            <div className="flex flex-col gap-6">
              ...
              <div className="flex gap-3 flex-wrap">
                ...
                <button
                  className="px-7 py-3.5 border-1.5 border-[#d9c1c0] text-[#1e1b18] rounded-lg font-medium text-sm transition-all hover:border-[#380208] hover:-translate-y-0.5 bg-transparent"
